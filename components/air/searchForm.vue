  ...
  <div class="search-form">
    ...
    <el-form class="search-form-content" ref="form" label-width="80px">
      ...
      <el-form-item label="出发城市" >
       <!-- fetch-suggestions 搜索框中返回建议的方法（框架中的远程搜索）
        select 点击选中建议项时触发 -->
        <el-autocomplete
...
export default {
  ...
  methods: {
    ...
    handleSearchTab(item, index) {
      if(index ===1){
        this.$confirm('目前不支持往返票，请使用单程选票！','提示',{
    ...
    async queryDepartSearch(value, cb) {
      //调用查询城市接口的方法querySearchAsync，获取实时城市列表数据
